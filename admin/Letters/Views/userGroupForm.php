            ...
            <div class="block">
                ...
                <div class="block-content">
                    <div class="form-group row">
                        <label class="col-sm-2 control-label" for="input-status">Parent</label>
                        <div class="col-md-10">
                            <?php echo form_dropdown('parent_id', option_array_value($parents, 'id', 'name','No Parent'), set_value('parent_id', $parent_id),array('class'=>'form-control','id'=>'parent_id')); ?>
                        </div>
                    </div>
