                ...
                <div class="sidebar-content">
                        ...
                        <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                            ...
                            <div class="content-header-item">
                                <a href="<?= admin_url() ?>" class="link-effect font-w700">
                                    <?php if ($logo) { ?>
                                        <img width="100%" height="40px" src="<?= $logo; ?>"
                                            title="<?= $site_name; ?>" alt="<?= $site_name; ?>" />
                                    <?php } ?>
                                    <i class="si si-fire text-primary"></i>
                                    <span class="font-size-xl text-dual-primary-dark">OMM Portal</span><span
                                        class="font-size-xl text-primary"> 2.0</span>
                                </a>
                    ...
                    <div class="content-side content-side-full">
                        ...
                        <?php if ($user->getGroupId() == 1) { ?>
                            <ul class="nav-main">
                                <li class="nav-main-heading"><span class="sidebar-mini-visible">DEV</span><span
                                        class="sidebar-mini-hidden">Developer Tools</span></li>
                                <li>
                                    <a href="<?= admin_url('module') ?>"><i class="si si-globe-alt"></i><span
                                            class="sidebar-mini-hide">HMVC Module</span></a>
