...
//echo $sql;exit;
    ...
    public function getAbstractMPR_old($filter=[]) {
        ...
        *
        ...
        LEFT JOIN (SELECT
          ...
          LEFT JOIN (SELECT
            ...
            AND smt.agency_type_id IN (5, 6)
            GROUP BY smt.block_id) `or`
          ...
          LEFT JOIN (SELECT
            ...
            AND ms.agency_type_id IN (5, 6)
            GROUP BY ms.block_id) mis
