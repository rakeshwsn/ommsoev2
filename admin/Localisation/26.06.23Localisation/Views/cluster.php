<div class="block">
	<div class="block-header block-header-default">
		...
		<div class="block-options">
			...
			<button type="button" data-toggle="tooltip" title="<?= $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?= $text_confirm; ?>') ? $('#form-cluster').submit() : false;"><i class="fa fa-trash-o"></i></button>
		</div>
	</div>
	<div class="block-content block-content-full">
				...
				<div class="row mg-b-25">
					<div class="col-lg-4">
						<div class="form-group mg-b-10-force">
							...
							<?= form_dropdown('district', option_array_value($districts, 'code', 'name',array(''=>'Select Districts')), set_value('district', ''),"id='filter_district' class='form-control js-select2'"); ?>
						</div>
					</div><!-- col-4 -->
					<div class="col-lg-4">
						<div class="form-group mg-b-10-force">
		...
		<form action="<?= $delete; ?>" method="post" enctype="multipart/form-data" id="form-cluster">        		
