<div class="block">
	...
	<div class="block-content block-content-full">
				...
				<div class="row mg-b-25">
					<div class="col-lg-4">
						<div class="form-group mg-b-10-force">
							...
							<?= form_dropdown('district_id', option_array_value($districts, 'id', 'name',array(''=>'Select Districts')), set_value('district_id', ''),"id='filter_district' class='form-control js-select2'"); ?>
						</div>
					</div><!-- col-4 -->
					<div class="col-lg-4">
						<div class="form-group mg-b-10-force">
							<label class="form-control-label">Block: <span class="tx-danger">*</span></label>
							<input type="text" name="block" class="form-control" placeholder="Block" id="filter_block"/>
						</div>
					</div>
					<!-- col-4 -->
		...
		<form action="<?= $delete; ?>" method="post" enctype="multipart/form-data" id="form-district">        		
