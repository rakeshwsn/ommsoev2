...
class Mpr3 extends AdminController
{
    ...
    public function index($action='') {
        ...
        $components = $reportModel->getMprNew($filter);
        ...
        return $this->template->view('Admin\Budgets\Views\mpr_block', $data);
    }
...
//        $data['components'] = $this->getTable($components, 'view');
    ...
    protected function filterPanel(&$data) {
        ...
        if($this->user->agency_type_id==11 || $this->user->user_group_id==1){
