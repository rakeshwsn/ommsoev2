                ...
                <div class="row mg-b-25">
                    ...
                    <div class="col-md-3">
                        <div class="form-group ">
                            ...
                            if ($active_fund_agency) {
                                $select_attributes = array_merge($select_attributes, array('readonly' => 'readonly'));
                            }
                            echo form_dropdown('fund_agency_id', option_array_values($fundagencies, 'fund_agency_id', 'fund_agency',[''=>'Select Fund Agency']), set_value('fund_agency_id', $active_fund_agency),$select_attributes); ?>
