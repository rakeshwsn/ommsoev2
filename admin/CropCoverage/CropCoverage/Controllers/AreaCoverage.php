...
<<<<<<< HEAD
	public function download()
	{
		...
		$current_month_id = getCurrentMonthId();
		
		if($current_month_id>$start_month && $current_month_id<$end_month){
			$current_season = 'kharif';
		}
		
		$start_month = $this->settings->rabi_start_month;
		$end_month = $this->settings->rabi_end_month;
		...
		$end_date = '2023-12-31';
=======
>>>>>>> 4a3269356e9f5e4574f8513f9d1d22a618e0a5ff
