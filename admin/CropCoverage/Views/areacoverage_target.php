...
if (empty($district_id)) { ?>
    <table id="block-coverage" class="table table-bordered table-striped table-vcenter table-responsive">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2" class="text-right">Millet Wise Total</td>

                <td colspan="3" class="total-ragi">
                    <?php
                    $totalRagiSum = 0;
                ...
                <td colspan="2" class="total-little-millet">
                    <?php
                ...
                <td class="total-barnyard-millet">
                    <?php
                ...
                <td class="total-little-millet-followup">
                    <?php
                ...
                <td class="total-foxtail-millet-followup">
                    <?php
                ...
                <td class="total-sorghum-followup">
                    <?php
                ...
                <td class="total-pearl-millet-followup">
                    <?php
                ...
                <td class="total-barnyard-millet-followup">
                    <?php
                ...
                <td class="total-kodo-millet-followup">
                    <?php
