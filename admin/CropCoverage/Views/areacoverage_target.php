...
<script>
    $(document).ready(function () {
        // Replace 'userDistrictId' with the actual district ID value
        var userDistrictId = <?= $district_id; ?>; // You need to pass the district ID from your PHP code

        // Check if the user has a district ID
        if (userDistrictId) {
            // User has a district ID, hide the filter panel
            $('#filter_panel').hide();
        } else {
            // User doesn't have a district ID, show the filter panel
            $('#filter_panel').show();
        }
    });
</script>