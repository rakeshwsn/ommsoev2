        ...
        <form method="post" id="establishmentform">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 form-group <?= $validation->hasError('village_id') ? 'is-invalid' : '' ?>">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <a href="<?= $add_village_url ?>" class="btn btn-sm btn-secondary"
                                       id="btn-add-village">Add Village</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 form-group mt-15 <?= $validation->hasError('management_unit_type') ? 'is-invalid' : '' ?>">
                            <label for="management_unit">Type of management unit<span
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 form-group <?= $validation->hasError('managing_unit_name') ? 'is-invalid' : '' ?>">
                            <label for="managing unit name">Name Of Managing Unit<span
                                        class="text-danger">*</span></label>
                            <input type="text" name="managing_unit_name" class="form-control" id="managing_unit_name"
                                   placeholder="Name"
                                   value="<?= set_value('managing_unit_name', $managing_unit_name) ?>" required>
                        ...
                        <div class="col-6 form-group <?= $validation->hasError('contact_person') ? 'is-invalid' : '' ?>">
                            ...
                            <input type="text" name="contact_person" class="form-control" id="contact_person"
                                   ...
                                   value="<?= set_value('contact_person', $contact_person) ?>" required>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="dotted-border mx-4 my-4 pd-3" id="center_info">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-6 form-group mt-15 <?= $validation->hasError('unit_id') ? 'is-invalid' : '' ?>">
                            <input type="radio" id="main_center" name="center_type"
                                   value="main_center" <?= $center_type == "main_center" ? 'checked' : ''; ?>>
                            <label for="main_center">Main Center</label>
                            <input type="radio" id="sub_center" name="center_type"
                                   value="sub_center" <?= $center_type == "sub_center" ? 'checked' : ''; ?>>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="equipments" class="table table-bordered table-striped table-vcenter">
                                ...
                                <?php if (isset($enterpriseequipments)) {
                                    ...
                                    foreach ($enterpriseequipments as $equipment) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" name="quantity[<?= $rows ?>]"
                                                       value="<?= $equipment->quantity ?>"></td>
                                            <td>
                                                <button type="button" class="btn-sm btn btn-danger btn pull-right"
                                ...
                                <tr id="footer">
                                    <td colspan="3">
                                        <button type="button" class="btn-sm btn btn-primary btn pull-right"
                                                id="equipment_row" href=""><i class="fa fa-plus"></i></button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-6 form-group <?= $validation->hasError('date_estd') ? 'is-invalid' : '' ?>">
                            <label for="Enterprise Establishment">Date of Enterprise Establishment<span
                                        class="text-danger">*</span></label>
                            <input type="date" name="date_estd" class="form-control" id="date_estd" placeholder="Date "
                                   value="<?= set_value('date_estd', $date_estd) ?>" min="2015-01-01" max="2030-12-31">
                        </div>
                        <div class="col-6 form-group <?= $validation->hasError('mou_date') ? 'is-invalid' : '' ?>">
                            <label for="Date of OMU Under OMM">Date of OMU Under OMM<span
                                        class="text-danger">*</span></label>
                            <input type="date" name="mou_date" class="form-control" id="mou_unit" placeholder="Date "
                                   value="<?= set_value('mou_date', $mou_date) ?>" min="2015-01-01" max="2030-12-31">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-6 form-group <?= $validation->hasError('budget_fin_yr_id') ? 'is-invalid' : '' ?>">
                            <label for="budget finnacial year">Budget Utilized of Financial year<span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-6 form-group <?= $validation->hasError('unit_budget') ? 'is-invalid' : '' ?>">
                            <label for="Established Unit Budget Head">Established Unit Budget Head<span
                                        class="text-danger">*</span></label>
                            <input type="text" name="unit_budget" class="form-control" id="unit_budget"
                                   placeholder="Enter Budget " value="<?= set_value('unit_budget', $unit_budget) ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6 form-group <?= $validation->hasError('unit_budget_amount') ? 'is-invalid' : '' ?>">
                            <label for="Budget Utilized in Ruppes">Budget Utilized in Ruppes<span
                                        class="text-danger">*</span></label>
                            <input type="text" name="unit_budget_amount" class="form-control" id="unit_budget_amount"
                                   placeholder=" Amount"
                                   value="<?= set_value('unit_budget_amount', $unit_budget_amount) ?>" required>
                        </div>
                        <div class="col-6 form-group <?= $validation->hasError('own_share') ? 'is-invalid' : '' ?>">
                            <label for="total own share">Investment by the WSHG/FPO<span
                                        class="text-danger">*</span></label>
                            <input type="text" name="own_share" class="form-control" id="own_share"
                                   placeholder="Enter total own share "
                                   value="<?= set_value('own_share', $own_share) ?>" required>
                        </div>
                    </div>
                </div>
            </div>
            <div class="dotted-border mx-4 my-4 pd-3">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <input type="checkbox" id="is_support_basis_infr" name="is_support_basis_infr"
                                   value="1" <?php echo ($is_support_basis_infr == 1) ? 'checked' : ''; ?>>
                    ...
                    <div class="block" id="budget_utilize">
                        <div class="row">
                            <div class=" col-6 form-group <?= $validation->hasError('purpose_infr_support') ? 'is-invalid' : '' ?>">
                                <label for="Purposeof Addl. infa structure">Type/ Purposeof Addl. infa structure<span
                                            class="text-danger">*</span></label>
                                <input type="text" name="purpose_infr_support" class="form-control"
                                       id="purpose_infr_support" placeholder="Type/ Purposeof Addl. infa structure "
                                       value="<?= set_value('purpose_infr_support', $purpose_infr_support) ?>">
                            </div>
                            <div class="  col-6 form-group <?= $validation->hasError('addl_budget') ? 'is-invalid' : '' ?>">
                                <label for="exampleInputEmail1">Budget Head Utilised for Addl. infra support<span
                                            class="text-danger">*</span></label>
                                <input type="text" name="addl_budget" class="form-control" id="addl_budget"
                                       placeholder="Enter Budget "
                                       value="<?= set_value('addl_budget', $addl_budget) ?>">
                            </div>
                        </div>

                        <div class="row">
                            <div class=" col-6 form-group <?= $validation->hasError('support_infr_amount') ? 'is-invalid' : '' ?>">
                                <label for="Budget Ruppes">Budget Utilized in Ruppes<span
                                            class="text-danger">*</span></label>
                                <input type="text" name="support_infr_amount" class="form-control"
                                       id="support_infr_amount" placeholder=" Amount"
                                       value="<?= set_value('support_infr_amount', $support_infr_amount) ?>">
                            </div>
