            ...
            <div class="container">
                ...
                <div class="row">
                    <div id="center_name" class="col-6 form-group mt-15 <?= $validation->hasError('') ? 'is-invalid' : '' ?>">
                        ...
                        <?php echo form_dropdown('main_center_id', $main_center_name, set_value('main_center_id', $main_center_id), ['class' => 'form-control', 'id' => 'main_center_list']); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.main_center_name) {
                        var html = '<option value="0">Select main center name</option>';
                        var selected = '';
                        $.each(response.main_center_name, function(k, v) {
                        if(v.main_center_id == <?= $main_center_id ?>){
                            selected = "selected = 'selected'"
                        }
                            html += '<option ' + selected + ' value="' + v.main_center_id + '">' + v.managing_unit_name + ' (' + v.management_unit_type + ')</option>';
                        });
