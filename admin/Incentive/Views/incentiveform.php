                ...
                <div class="block">
                    ...
                    <div class="form-group row">
                        ...
                        <select class="form-control" id="" name="season">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label required-field" for="example-hf-email">GP<span style="color: red;">*</span></label>
                                <div class="col-lg-10 <?= $validation->hasError('gp') ? 'is-invalid' : '' ?>">
                                    <input type="hidden" name="id" id="id" value="<?= $id ?>" />
                                    <?php echo form_input(array('class' => 'form-control', 'name' => 'gp', 'id' => 'gp', 'placeholder' => 'GP', 'value' => set_value('gp', $gp), 'required' => 'required')); ?>
                                    <div class="invalid-feedback animated fadeInDown"><?= $validation->getError('gp'); ?></div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Village<span style="color: red;">*</span></label>
                                <div class="col-lg-10 <?= $validation->hasError('village') ? 'is-invalid' : '' ?>">
                                    <input type="hidden" name="id" id="id" value="<?= $id ?>" />
                                    <?php echo form_input(array('class' => 'form-control', 'name' => 'village', 'id' => 'village', 'placeholder' => 'village', 'value' => set_value('village', $village), 'required' => 'required')); ?>
                                    <div class="invalid-feedback animated fadeInDown"><?= $validation->getError('village'); ?></div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Name<span style="color: red;">*</span></label>
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Gender<span style="color: red;">*</span></label>
                                <div class="col-lg-10 <?= $validation->hasError('spouse_name') ? 'is-invalid' : '' ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10 <?= $validation->hasError('phone_no') ? 'is-invalid' : '' ?>">
                                    <span style="color: red;">phone no must be 10 character and Number only(with out adding +91)</span>
                                    <input type="hidden" name="id" id="id" value="<?= $id ?>" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10 <?= $validation->hasError('aadhar_no') ? 'is-invalid' : '' ?>">
                                    <span style="color: red;">Aadhar no must be 12 character and Number only</span>
                                    <input type="hidden" name="id" id="id" value="<?= $id ?>" />
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Year Support<span style="color: red;">*</span></label>
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Demonstration Area in Hectare<span style="color: red;">*</span></label>
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Bank Name<span style="color: red;">*</span></label>
                                <div class="col-lg-10 <?= $validation->hasError('bank_name') ? 'is-invalid' : '' ?>">
                                    <input type="hidden" name="id" id="id" value="<?= $id ?>" />
                                    <?php echo form_input(array('class' => 'form-control', 'name' => 'bank_name', 'id' => 'bank_name', 'placeholder' => 'Bank Name', 'value' => set_value('bank_name', $bank_name), 'required' => 'required')); ?>
                                    <div class="invalid-feedback animated fadeInDown"><?= $validation->getError('bank_name'); ?></div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Account No<span style="color: red;">*</span></label>
                                <div class="col-lg-10 <?= $validation->hasError('bank_name') ? 'is-invalid' : '' ?>">
                                    <input type="hidden" name="id" id="id" value="<?= $id ?>" />
                                    <?php echo form_input(array('class' => 'form-control', 'name' => 'account_no', 'id' => 'account_no', 'placeholder' => 'Account No', 'value' => set_value('account_no', $account_no), 'required' => 'required')); ?>
                                    <div class="invalid-feedback animated fadeInDown"><?= $validation->getError('bank_name'); ?></div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Ifsc Code<span style="color: red;">*</span></label>
                                <div class="col-lg-10 <?= $validation->hasError('ifsc') ? 'is-invalid' : '' ?>">
                                    <input type="hidden" name="id" id="id" value="<?= $id ?>" />
                                    <?php echo form_input(array('class' => 'form-control', 'name' => 'ifsc', 'id' => 'ifsc', 'placeholder' => 'Ifsc Code', 'value' => set_value('ifsc', $ifsc), 'required' => 'required')); ?>
                                    <div class="invalid-feedback animated fadeInDown"><?= $validation->getError('ifsc'); ?></div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Amount<span style="color: red;">*</span></label>
                                <div class="col-lg-10 <?= $validation->hasError('amount') ? 'is-invalid' : '' ?>">
                                    <input type="hidden" name="id" id="id" value="<?= $id ?>" />
                                    <?php echo form_input(array('class' => 'form-control', 'name' => 'amount', 'id' => 'amount', 'placeholder' => 'Amount', 'value' => set_value('amount', $amount), 'required' => 'required')); ?>
